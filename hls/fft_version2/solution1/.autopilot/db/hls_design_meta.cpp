...
const Port_Property HLS_Design_Meta::port_props[]={
	Port_Property("in_r_dout", 32, hls_in, 0, "ap_fifo", "fifo_data", 0),
	Port_Property("in_r_empty_n", 1, hls_in, 0, "ap_fifo", "fifo_status", 0),
	Port_Property("in_r_read", 1, hls_out, 0, "ap_fifo", "fifo_update", 0),
