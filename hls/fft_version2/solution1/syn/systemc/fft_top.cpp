...
fft_top::fft_top(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    xn_channel_U = new fifo_w32_d1024_A("xn_channel_U");
    ...
    xk_channel_U = new fifo_w32_d1024_A("xk_channel_U");
    ...
    start_for_fft_condEe_U = new start_for_fft_condEe("start_for_fft_condEe_U");
    start_for_fft_condEe_U->clk(ap_clk);
    start_for_fft_condEe_U->reset(ap_rst);
    start_for_fft_condEe_U->if_read_ce(ap_var_for_const0);
    start_for_fft_condEe_U->if_write_ce(ap_var_for_const0);
    start_for_fft_condEe_U->if_din(start_for_fft_config1_U0_din);
    start_for_fft_condEe_U->if_full_n(start_for_fft_config1_U0_full_n);
    start_for_fft_condEe_U->if_write(dummy_proc_fe_U0_start_write);
    start_for_fft_condEe_U->if_dout(start_for_fft_config1_U0_dout);
    start_for_fft_condEe_U->if_empty_n(start_for_fft_config1_U0_empty_n);
    start_for_fft_condEe_U->if_read(fft_config1_U0_ap_ready);
    start_for_dummy_peOg_U = new start_for_dummy_peOg("start_for_dummy_peOg_U");
    start_for_dummy_peOg_U->clk(ap_clk);
    start_for_dummy_peOg_U->reset(ap_rst);
    start_for_dummy_peOg_U->if_read_ce(ap_var_for_const0);
    start_for_dummy_peOg_U->if_write_ce(ap_var_for_const0);
    start_for_dummy_peOg_U->if_din(start_for_dummy_proc_be_U0_din);
    start_for_dummy_peOg_U->if_full_n(start_for_dummy_proc_be_U0_full_n);
    start_for_dummy_peOg_U->if_write(dummy_proc_fe_U0_start_write);
    start_for_dummy_peOg_U->if_dout(start_for_dummy_proc_be_U0_dout);
    start_for_dummy_peOg_U->if_empty_n(start_for_dummy_proc_be_U0_empty_n);
    start_for_dummy_peOg_U->if_read(dummy_proc_be_U0_ap_ready);
...
fft_top::~fft_top() {
    ...
    delete xn_channel_U;
    delete xk_channel_U;
    delete start_for_fft_condEe_U;
    delete start_for_dummy_peOg_U;
}
