...
proc create_root_design { parentCell } {
  ...
  set op [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:acc_fifo_read_rtl:1.0 op ]
  ...
  set res [ create_bd_port -dir O -type data res ]
  set res_ap_vld [ create_bd_port -dir O res_ap_vld ]

  # Create instance: hls_inst, and set properties
  set hls_inst [ create_bd_cell -type ip -vlnv TeamMLG:hls:kernel:1.0 hls_inst ]

  # Create interface connections
  connect_bd_intf_net -intf_net ap_ctrl_0_1 [get_bd_intf_ports ap_ctrl] [get_bd_intf_pins hls_inst/ap_ctrl]
  connect_bd_intf_net -intf_net hls_inst_op [get_bd_intf_ports op] [get_bd_intf_pins hls_inst/op]
  ...
  connect_bd_net -net hls_inst_res [get_bd_ports res] [get_bd_pins hls_inst/res]
  connect_bd_net -net hls_inst_res_ap_vld [get_bd_ports res_ap_vld] [get_bd_pins hls_inst/res_ap_vld]
