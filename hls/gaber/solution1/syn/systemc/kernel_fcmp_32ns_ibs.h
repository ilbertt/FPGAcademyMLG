...
// ==============================================================
#ifndef __kernel_fcmp_32ns_ibs__HH__
#define __kernel_fcmp_32ns_ibs__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_fcmp_32ns_ibs) {
    ...
    SC_CTOR(kernel_fcmp_32ns_ibs):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
