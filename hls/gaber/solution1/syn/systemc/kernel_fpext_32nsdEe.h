...
// ==============================================================
#ifndef __kernel_fpext_32nsdEe__HH__
#define __kernel_fpext_32nsdEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_fpext_32nsdEe) {
    ...
    SC_CTOR(kernel_fpext_32nsdEe):  ACMP_fpext_U ("ACMP_fpext_U") {
