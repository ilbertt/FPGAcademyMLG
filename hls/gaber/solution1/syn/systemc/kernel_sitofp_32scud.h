...
// ==============================================================
#ifndef __kernel_sitofp_32scud__HH__
#define __kernel_sitofp_32scud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_sitofp_32scud) {
    ...
    SC_CTOR(kernel_sitofp_32scud):  ACMP_sitofp_U ("ACMP_sitofp_U") {
