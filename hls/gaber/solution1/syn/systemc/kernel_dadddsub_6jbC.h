...
// ==============================================================
#ifndef __kernel_dadddsub_6jbC__HH__
#define __kernel_dadddsub_6jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_dadddsub_6jbC) {
    ...
    ACMP_dadddsub<ID, 6, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_dadddsub_U;

    SC_CTOR(kernel_dadddsub_6jbC):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
