...
// ==============================================================
#ifndef __kernel_fptrunc_64hbi__HH__
#define __kernel_fptrunc_64hbi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_fptrunc_64hbi) {
    ...
    SC_CTOR(kernel_fptrunc_64hbi):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
