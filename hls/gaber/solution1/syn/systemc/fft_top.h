...
struct fft_top : public sc_module {
    ...
    sc_signal< sc_lv<9> > dummy_proc_be_U0_out_r_address0;
    sc_signal< sc_logic > dummy_proc_be_U0_out_r_ce0;
    sc_signal< sc_logic > dummy_proc_be_U0_out_r_we0;
    sc_signal< sc_lv<32> > dummy_proc_be_U0_out_r_d0;
