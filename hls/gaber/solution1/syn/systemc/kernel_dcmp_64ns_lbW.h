...
// ==============================================================
#ifndef __kernel_dcmp_64ns_lbW__HH__
#define __kernel_dcmp_64ns_lbW__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_dcmp_64ns_lbW) {
    ...
    SC_CTOR(kernel_dcmp_64ns_lbW):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
