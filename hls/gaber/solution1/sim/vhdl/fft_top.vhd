...
architecture behav of fft_top is 
    ...
    signal dummy_proc_fe_U0_config_data_V_read : STD_LOGIC;
    ...
    signal dummy_proc_be_U0_out_r_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal dummy_proc_be_U0_out_r_ce0 : STD_LOGIC;
    signal dummy_proc_be_U0_out_r_we0 : STD_LOGIC;
    signal dummy_proc_be_U0_out_r_d0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component start_for_fft_coneOg IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_dummy_pfYi IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        config_data_V_read => dummy_proc_fe_U0_config_data_V_read,
    ...
    port map (
        ...
        out_r_address0 => dummy_proc_be_U0_out_r_address0,
        out_r_ce0 => dummy_proc_be_U0_out_r_ce0,
        out_r_we0 => dummy_proc_be_U0_out_r_we0,
        out_r_d0 => dummy_proc_be_U0_out_r_d0);
    ...
    port map (
        ...
        if_read => dummy_proc_fe_U0_config_data_V_read);

    xn_channel_U : component fifo_w32_d2048_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    xk_channel_U : component fifo_w32_d2048_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_fft_coneOg_U : component start_for_fft_coneOg
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_dummy_pfYi_U : component start_for_dummy_pfYi
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    dummy_proc_be_U0_ap_continue <= ap_continue;
