...
architecture behav of dummy_proc_be is 
    ...
    signal tmp_25_fu_701_p3 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_26_fu_756_p3 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    kernel_fadd_32ns_dEe_U9 : component kernel_fadd_32ns_dEe
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    kernel_fmul_32ns_bkb_U10 : component kernel_fmul_32ns_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    kernel_fmul_32ns_bkb_U11 : component kernel_fmul_32ns_bkb
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    p_Result_18_fu_708_p5 <= (m_15_fu_680_p1(63 downto 32) & tmp_25_fu_701_p3 & m_15_fu_680_p1(22 downto 0));
    p_Result_19_fu_232_p3 <= in_r_dout(31 downto 31);
    p_Result_20_fu_319_p3 <= (ap_const_lv16_FFFF & p_Result_11_reg_845);
    p_Result_21_fu_763_p5 <= (m_16_fu_735_p1(63 downto 32) & tmp_26_fu_756_p3 & m_16_fu_735_p1(22 downto 0));
    ...
    tmp_25_fu_701_p3 <= (p_Result_16_reg_809_pp0_iter3_reg & add_ln964_fu_695_p2);
    tmp_26_fu_756_p3 <= (p_Result_19_reg_832_pp0_iter3_reg & add_ln964_1_fu_750_p2);
