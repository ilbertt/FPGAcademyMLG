...
// ==============================================================
#ifndef __kernel_fpext_32nscud__HH__
#define __kernel_fpext_32nscud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_fpext_32nscud) {
    ...
    SC_CTOR(kernel_fpext_32nscud):  ACMP_fpext_U ("ACMP_fpext_U") {
