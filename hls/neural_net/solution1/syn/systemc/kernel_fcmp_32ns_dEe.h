...
// ==============================================================
#ifndef __kernel_fcmp_32ns_dEe__HH__
#define __kernel_fcmp_32ns_dEe__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_fcmp_32ns_dEe) {
    ...
    SC_CTOR(kernel_fcmp_32ns_dEe):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
