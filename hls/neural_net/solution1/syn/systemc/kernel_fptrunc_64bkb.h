...
// ==============================================================
#ifndef __kernel_fptrunc_64bkb__HH__
#define __kernel_fptrunc_64bkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_fptrunc_64bkb) {
    ...
    SC_CTOR(kernel_fptrunc_64bkb):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
