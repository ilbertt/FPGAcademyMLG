...
architecture behav of act_fun is 
    ...
    signal tmp_15_reg_250 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_16_reg_270 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_23_reg_280 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component kernel_fptrunc_64bkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component kernel_fcmp_32ns_dEe IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component kernel_dadd_64ns_eOg IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component kernel_dsub_64ns_fYi IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component kernel_dmul_64ns_g8j IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    kernel_fptrunc_64bkb_U1 : component kernel_fptrunc_64bkb
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    kernel_fptrunc_64bkb_U2 : component kernel_fptrunc_64bkb
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    kernel_fpext_32nscud_U3 : component kernel_fpext_32nscud
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    kernel_fcmp_32ns_dEe_U4 : component kernel_fcmp_32ns_dEe
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    kernel_fcmp_32ns_dEe_U5 : component kernel_fcmp_32ns_dEe
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    kernel_fcmp_32ns_dEe_U6 : component kernel_fcmp_32ns_dEe
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    kernel_fcmp_32ns_dEe_U7 : component kernel_fcmp_32ns_dEe
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    kernel_fcmp_32ns_dEe_U8 : component kernel_fcmp_32ns_dEe
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    kernel_dadd_64ns_eOg_U9 : component kernel_dadd_64ns_eOg
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 64,
    ...
    kernel_dsub_64ns_fYi_U10 : component kernel_dsub_64ns_fYi
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 64,
    ...
    kernel_dmul_64ns_g8j_U11 : component kernel_dmul_64ns_g8j
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 64,
    ...
    kernel_dmul_64ns_g8j_U12 : component kernel_dmul_64ns_g8j
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 64,
    ...
    kernel_dmul_64ns_g8j_U13 : component kernel_dmul_64ns_g8j
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 64,
