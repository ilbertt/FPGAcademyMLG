...
HLS_SOURCES = ../../testbench.cpp ../../kernel.cpp ../../mylib.c
...
$(ObjDir)/mylib.o: ../../mylib.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../mylib.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/mylib.d
